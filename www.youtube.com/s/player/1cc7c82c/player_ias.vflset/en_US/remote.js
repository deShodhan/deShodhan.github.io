(function(g) {
    ...
    var PQa = function(a, b) {
        ...
        S6 = function(a) {
            ...
            a && (this.id = a.id || a.name, this.name = a.name, this.clientName = a.clientName ? a.clientName.toUpperCase() : "UNKNOWN_INTERFACE", this.app = a.app, this.type = a.type || "REMOTE_CONTROL", this.username =
                a.user || "", this.avatar = a.userAvatarUri || "", this.obfuscatedGaiaId = a.obfuscatedGaiaId || "", this.theme = a.theme || "u", ZQa(this, a.capabilities || ""), $Qa(this, a.experiments || ""), this.brand = a.brand || "", this.model = a.model || "", this.year = a.year || 0, this.os = a.os || "", this.osVersion = a.osVersion || "", this.chipset = a.chipset || "", this.mdxDialServerType = a.mdxDialServerType || "MDX_DIAL_SERVER_TYPE_UNKNOWN", a = a.deviceInfo) && (a = JSON.parse(a), this.brand = a.brand || "", this.model = a.model || "", this.year = a.year || 0, this.os = a.os || "",
        ...
        ZQa = function(a, b) {
            ...
            g.Io(b.split(","), g.Oa(PQa, aRa)).forEach(function(c) {
        ...
        dRa = function(a) {
            return Array.isArray(a) ? g.wm(a, cRa) : []
        },
        V6 = function(a) {
        ...
        i7 = function() {
            if (uRa) {
                ...
                rRa("//www.gstatic.com/cast/sdk/libs/sender/1.0/cast_framework.js", h7, c)
            }
        },
        vRa = function() {
            i7();
        ...
        xRa = function() {
            i7();
            var a = tRa();
            a.push.apply(a, g.v(wRa.map(sRa)));
            a.push("//www.gstatic.com/eureka/clank/cast_sender.js");
            g7(a)
        },
        j7 = function(a, b, c) {
        ...
        JRa = function(a) {
            ...
            N6(b);
            HRa(b.toString(), 5E3, (0, g.E)(a.nQ, a), 3, 2E3);
            a.wj(1)
        },
        C7 = function(a) {
            var b = a.i.N;
        ...
        URa = function(a, b) {
            ...
            } else 3 == a.Ta && (b ? TRa(a, b) : 0 == a.i.length || a.Yg || TRa(a))
        },
        TRa = function(a, b) {
            if (b)
                if (6 < a.ip) {
        ...
        I7 = function(a) {
            ...
            a.J++;
            a.Al = n7((0, g.E)(a.KL, a), WRa(a, a.wr));
            a.wr++;
            return !0
        },
        B7 = function(a, b, c) {
        ...
        A7 = function(a, b, c) {
            ...
            if ("" != d.i) b && g.Vj(d, b + "." + d.i), g.Wj(d, d.B);
                ...
                d = YQa(e.protocol, b ? b + "." + e.hostname : e.hostname, +e.port, c)
            }
        ...
        bSa = function(a, b) {
            ...
            a.u.stop();
            M7(a);
            a.i && (3 == a.i.getState() && URa(a.i), PRa(a.i));
            a.N = 0
        },
        N7 = function(a) {
        ...
        S7 = function(a, b) {
            dSa();
            var c = gSa(a, String(b));
            g.jb(R7) ? hSa(c) : (eSa(), g.Cb(R7, function(d) {
                d(c)
            }))
        },
        dSa = function() {
        ...
        kSa = function(a, b) {
            ...
            for (var d = 0, e = b.length; d < e; d++) c = jSa(a, b[d]) || c;
            return c
        },
        lSa = function(a, b) {
        ...
        Y7 = function(a) {
            if (g.ls("deprecate_pair_servlet_enabled")) return kSa(a, []);
            var b = dRa(jRa());
            b = g.Io(b, function(c) {
                return !c.uuid
            });
        ...
        d8 = function(a, b) {
            a: if (P6(b) != P6(a.i)) var c = !1;
                    ...
                    c = !0
                }c || (a8("Updated online screens: " + g.Nh(a.i)), a.i = b, a.Z("screenChange"));nSa(a)
        },
        e8 = function(a) {
            isNaN(a.B) || g.jt(a.B);
        ...
        rSa = function(a, b, c, d, e, f) {
            ...
            } else c ? qSa(a, c, (0, g.E)(function(n) {
        ...
        pSa = function(a) {
            ...
            uSa(a);
            a.K || (a.B = dRa(g.Nz("yt-remote-automatic-screen-cache") || []));
            h8(a);
        ...
        g8 = function(a, b) {
            var c = a.get(b.id);
            c ? (c.uuid = b.uuid, b = c) : ((c = Z6(a.B, b.uuid)) ? (c.id = b.id, c.token = b.token, b = c) : a.B.push(b), a.K || vSa(a));
            h8(a);
            a.D[b.uuid] = b.id;
        ...
        vSa = function(a) {
            ...
            g.Mz("yt-remote-automatic-screen-cache", g.wm(a, bRa))
        },
        h8 = function(a) {
        ...
        m8 = function(a, b) {
            g.jt(a.K);
            a.K = 0;
            0 == b ? ySa(a) : a.K = g.ht(function() {
                ySa(a)
            }, b)
        },
        ySa = function(a) {
            zSa(a, "getLoungeToken");
            g.jt(a.D);
            a.D = g.ht(function() {
                ASa(a, null)
            }, 3E4)
        ...
        xSa = function(a, b) {
            g.jt(a.ea);
            a.ea = 0;
            b ? a.config_.enableCastLoungeToken && b.loungeToken ? b.deviceId ? a.getScreen() && a.getScreen().uuid == b.deviceId || (b.loungeTokenRefreshIntervalMs ? CSa(a, {
        ...
        ASa = function(a, b) {
            ...
            c ? (a.info("Did not receive a new lounge token in onLoungeToken_ with data: " + (JSON.stringify(b) + ", error: " + c)), a.V = c, m8(a, 3E4)) : (wSa(a, b.loungeToken), a.ya = !1, a.V = "unknown", m8(a, b.loungeTokenRefreshIntervalMs))
        },
        BSa = function(a, b, c, d) {
            g.jt(a.J);
            a.J = 0;
            tSa(a.B, b, function(e) {
        ...
        r8 = function(a) {
            return new Promise(function(b) {
                a.Ba = X6();
                if (a.Ma) {
                    var c = new chrome.cast.DialLaunchResponse(!0, FSa(a));
                    b(c);
                    ESa(a)
                } else a.ea = function() {
                    g.jt(a.V);
                    a.ea = function() {};
                    a.V = NaN;
                    var d = new chrome.cast.DialLaunchResponse(!0, FSa(a));
                    b(d);
                    ESa(a)
                }, a.V = g.ht(function() {
                    a.ea()
        ...
        q8 = function(a, b) {
            ...
            p8(a) && (g.jt(a.K), a.K = 0, 0 == b ? JSa(a) : a.K = g.ht(function() {
                JSa(a)
            }, b))
        },
        JSa = function(a) {
            p8(a) && a.u.getDialAppInfo(function(b) {
                ...
                c ? (a.ya = c, q8(a, 3E4)) : (a.ma = !1, a.ya = "unknown", wSa(a, b.loungeToken), q8(a, b.loungeTokenRefreshIntervalMs))
            }, function(b) {
        ...
        SSa = function(a, b, c, d) {
            d.disableCastApi ? x8("Cannot initialize because disabled by Mdx config.") : OSa() ? PSa(b, d) && (y8(!0), window.chrome && chrome.cast && chrome.cast.isAvailable ? QSa(a, c) : (window.__onGCastApiAvailable = function(e, f) {
                e ? QSa(a, c) : (z8("Failed to load cast API: " + f), A8(!1), y8(!1), g.Pz("yt-remote-cast-available"), g.Pz("yt-remote-cast-receiver"),
                    RSa(), c(!1))
            }, d.loadCastApiSetupScript ? g.Rz("https://www.gstatic.com/cv/js/sender/v1/cast_sender.js") : 0 <= window.navigator.userAgent.indexOf("Android") && 0 <= window.navigator.userAgent.indexOf("Chrome/") && window.navigator.presentation ? 60 <= f7() && vRa() : !window.chrome || !window.navigator.presentation || 0 <= window.navigator.userAgent.indexOf("Edge") ? h7() : 89 <= f7() ? xRa() : (i7(), g7(wRa.map(sRa))))) : x8("Cannot initialize because not running Chrome")
        },
        RSa = function() {
            x8("dispose");
            var a = B8();
        ...
        QSa = function(a, b) {
            ...
            y8(!1);
            XSa(a, function(c) {
                c ? (TSa(!0), g.Yu("yt-remote-cast2-api-ready")) : (z8("Failed to initialize cast API."), A8(!1), g.Pz("yt-remote-cast-available"), g.Pz("yt-remote-cast-receiver"), RSa());
                b(c)
            })
        },
        x8 = function(a) {
        ...
        P8 = function(a, b) {
            ...
            var c = 0;
            a ? (c = a.getProxyState(), 3 != c && (a.subscribe("proxyStateChange", this.iF, this), YSa(this))) : c = 3;
        ...
        fTa = function(a, b) {
            ...
            b && ($8(a), a9(a));
            c = N7(a.i) && isNaN(a.D);
            b == c ? b && (Z8(a, 1), c9(a, "getSubtitlesTrack")) : b ? (a.vJ() && a.lc.reset(), Z8(a, 1), c9(a, "getNowPlaying"), eTa(a)) : a.Ir(1)
        },
        gTa = function(a, b) {
        ...
        rTa = function(a, b) {
            ...
            if (!e7 || !e7.get("yt-remote-disable-remote-module-for-dev")) {
                ...
                fRa();
                c7();
                e9 || (e9 = new O7(b ? b.loungeApiHost : void 0), oRa() && (e9.i = "/api/loungedev"));
                ...
                b && !g.Ga("yt.mdx.remote.initialized_") && (g.Fa("yt.mdx.remote.initialized_", !0, void 0), i9("Initializing: " +
                    ...
                    })), j9.push(g.Wu("yt-remote-cast2-session-change", pTa)), j9.push(g.Wu("yt-remote-connection-change", function(f) {
                        f ? G8(h9(), "YouTube TV") : l9() || (G8(null, null), VSa())
                    ...
                    e.push("atp"), 0 < e.length && (a.capabilities = e), a.name = b.device, a.app = b.app, (b = b.theme) && (a.theme = b), i9(" -- with channel params: " + g.Nh(a)), a ? (g.Mz("yt-remote-session-app", a.app), g.Mz("yt-remote-session-name", a.name)) : (g.Pz("yt-remote-session-app"), g.Pz("yt-remote-session-name")), g.Fa("yt.mdx.remote.channelParams_", a, void 0), c.start(), h9() || qTa())
            }
        },
        sTa = function() {
            var a = g9().Pe.$_gos();
        ...
        qTa = function() {
            var a = l9();
            a ? (i9("Resume connection to: " + V6(a)), s9(a, 0)) : (d7(), VSa(), i9("Skipping connecting because no session screen found."))
        },
        oTa = function() {
            var a = m9();
            if (g.Wb(a)) {
        ...
        A9 = function(a, b) {
            ...
            a.Sb.playVideo(c.videoId, b, d, e, c.playerParams, c.Ya, VQa(c));
            a.Tb(new g.dK(1))
        },
        yTa = function(a, b) {
            if (b) {
        ...
        B9 = function() {
            g.V.call(this, {
                ...
                T: [{
                    ...
                    T: [{
                        ...
                        xa: "Connecting to your TV on web using a code will be going away soon"
                    }, {
                        G: "div",
            ...
            this.learnMoreButton =
                this.Ga("ytp-mdx-manual-pairing-popup-learn-more");
        ...
        zTa = function(a, b) {
            if (3 === a.api.getPresentingPlayerType()) {
                ...
                b = g.U(b, 128) ? g.BI("Error on $RECEIVER_NAME", c) : b.zc() || g.U(b, 4) ? g.BI("Playing on $RECEIVER_NAME", c) : g.BI("Connected to $RECEIVER_NAME", c);
                a.Va("statustext", b);
                a.i.show()
            } else a.i.hide()
        },
        E9 = function(a, b) {
            g.WP.call(this, "Play on", 0, a, b);
            this.I = a;
            this.oo = {};
        ...
        H9 = function(a, b) {
            if (b.key !== a.Xm.key)
                if (b.key === a.tj.key) r9();
                    ...
                    if (a.As && !a.fz && b !== a.tj && "cast-selector-receiver" !== b.key && g.GF(a.player.U())) CTa(a);
                    else {
                        var c;
                        ...
                        (c ? 0 : g.GF(a.player.U()) || g.JF(a.player.U())) && DTa(a)
                    }
                    a.Xm = b;
        ...
        e7, a7 = "",
        uRa = pRa("loadCastFramework") || pRa("loadCastApplicationFramework"),
        wRa = ["pkedcjkdefgpdelpbcmbmeomcjbeemfm", "enhhojjnijigcajfphajepfemndkmdlo"];
    /*
    ...
    */
    ...
    g.k.MV = function() {
        this.zt = null;
        var a = Date.now();
        0 <= a - this.XF ? (2 != this.jt && this.i.wj(3), u7(this), this.Km = 2, p7(18), v7(this)) : FRa(this, this.XF - a)
    };
    ...
    g.k.connect = function(a) {
        ...
        this.MM = Date.now();
        var b = this.i.K;
        null != b ? (this.Vt = b[0], (this.xu = b[1]) ? (this.Ta = 1, JRa(this)) : (this.Ta = 2, C7(this))) : (O6(a, "MODE", "init"), this.rh = new q7(this, void 0, void 0, void 0), this.rh.Po = this.yB, r7(this.rh, a, !1, null, !0), this.Ta = 0)
    };
    g.k.nQ = function(a) {
    ...
    g.k.qx = function() {
        this.dl = this.rh.Ut;
        if (this.rh.Bm) 0 == this.Ta ? this.xu ? (this.Ta = 1, JRa(this)) : (this.Ta = 2, C7(this)) : 2 == this.Ta && ((!g.ke || g.ce(10) ? !this.Xz : 200 > this.LD - this.Yx) ? (p7(11), B7(this.i, this, !1)) : (p7(12), B7(this.i, this, !0)));
        else {
    ...
    g.k.connect = function(a, b, c, d, e) {
        ...
        this.D ? (n7((0, g.E)(this.AI, this, a), 100), QRa(this)) : this.AI(a)
    };
    g.k.AI = function(a) {
        this.Vm = new IRa(this);
        this.Vm.yB = this.Yj;
        this.Vm.u = this.C;
        this.Vm.connect(a)
    };
    ...
    g.k.GL = function(a, b) {
        if (0 != this.Ta && (this.Fe == a || this.Yg == a))
            ...
            a && G7(this), !g.yc(b))
            for (a = this.C.parse(b), b = 0; b < a.length; b++) c = a[b], this.us = c[0], c = c[1], 2 == this.Ta ? "c" == c[0] ? (this.u = c[1], this.sx = c[2], c = c[3], null != c ? this.ip = c : this.ip = 6, this.Ta = 3, this.Of && this.Of.wI(), this.dI = A7(this, this.Lw() ? this.sx : null, this.AB), VRa(this)) : "stop" == c[0] && J7(this, 7) : 3 == this.Ta && ("stop" == c[0] ? J7(this, 7) : "noop" != c[0] && this.Of && this.Of.vI(c), this.wr = 0)
    };
    g.k.cT = function() {
        ...
        if (0 != this.Ta)
            if (a.Bm)
                if (1 == b) {
                    b = Date.now() - a.Qs;
                    var c = o7;
                    c.dispatchEvent(new LRa(c, a.lq ? a.lq.length : 0, b, this.Mr));
                    F7(this);
                    this.B.length = 0
                } else VRa(this);
        else {
            ...
            if (!(d = 3 == c || 7 == c || 0 == c && 0 < this.Zj)) {
                if (d = 1 == b) this.Yg || this.pn || 1 == this.Ta || 2 <= this.Mr ? d = !1 : (this.pn = n7((0, g.E)(this.LL, this, a), WRa(this, this.Mr)), this.Mr++, d = !0);
                d = !(d || 2 == b && I7(this))
            }
            if (d) switch (c) {
                case 1:
    ...
    g.k.dispose = function() {
        this.ea || (this.ea = !0, g.of(this.B), bSa(this), g.of(this.u), this.u = null, this.ma = function() {
            return ""
        })
    };
    ...
    g.k.connect = function(a, b, c) {
        if (!this.i || 2 != this.i.getState()) {
            ...
            e ? (3 != e.getState() && 0 == SRa(e) || e.getState(), this.i.connect(a, b, this.J, e.u, e.us)) : c ? this.i.connect(a,
    ...
    g.k.sendMessage = function(a, b) {
        ...
        b && g.ec(a, b);
        this.u.isActive() || 2 == (this.i ? this.i.getState() : 0) ? this.K.push(a) : N7(this) && (M7(this), RRa(this.i, a))
    };
    g.k.wI = function() {
        this.u.reset();
        this.D = null;
        ...
        if (this.K.length) {
            var a = this.K;
            this.K = [];
            for (var b = 0, c = a.length; b < c; ++b) RRa(this.i, a[b])
        }
    ...
    g.k.vI = function(a) {
        "S" == a[0] ? this.V = a[1] : "gracefulReconnect" == a[0] ? (this.u.start(), PRa(this.i)) : this.Z("handlerMessage", new $Ra(a[0], a[1]))
    };
    g.k.iA = function(a) {
    ...
    g.k.pW = function() {
        this.u.isActive();
        0 == SRa(this.i) && this.connect(this.D, this.C)
    };
    ...
    g.k.tP = function(a) {
        this.i = null;
        a.status && 404 == a.status ? this.u >= ETa.length ? this.Z("pairingFailed", Error("DIAL polling timed out")) : (a = ETa[this.u], this.Mb = g.ht((0, g.E)(this.UL, this), a), this.u++) : this.Z("pairingFailed", Error("Server error " + a.status))
    };
    g.k.vP = function() {
        this.i = null;
        this.Z("pairingFailed", Error("Server not responding"))
    };
    var ETa = [2E3, 2E3, 1E3, 1E3, 1E3, 2E3, 2E3, 5E3, 5E3, 1E4];
    g.Qa(Z7, W7);
    g.k = Z7.prototype;
    g.k.start = function() {
        Y7(this) && this.Z("screenChange");
        !g.Nz("yt-remote-lounge-token-expiration") && mSa(this);
        g.jt(this.i);
    ...
    g.k.wP = function(a, b, c, d) {
        g.ot(P7(this.C, "/pairing/get_screen"), {
            ...
            onSuccess: (0, g.E)(function(e, f) {
                e = new T6(f.screen || {});
                if (!e.name || sSa(this, e.name)) {
                    a: {
                        f = e.name;
                        for (var h = 2, l = b(f, h); sSa(this, l);) {
                            h++;
                            if (20 < h) break a;
                            l = b(f, h)
                        }
    ...
    g.k.wJ = function(a, b, c, d) {
        g.jt(this.N);
        this.N = 0;
        rSa(this.B, this.i.label, a, this.i.friendlyName, (0, g.E)(function(e) {
    ...
    g.k.init = function(a, b) {
        ...
        chrome.cast.initialize(c, (0, g.E)(function() {
            this.isDisposed() ||
                (chrome.cast.addReceiverActionListener(this.D), fSa(), this.u.subscribe("onlineScreenChange", (0, g.E)(this.bH, this)), this.B = NSa(this), chrome.cast.setCustomReceivers(this.B, g.Ha, (0, g.E)(function(f) {
    ...
    g.k.xT = function(a) {
        ...
        b = this.i;
        b.N = a;
        b.N.appState == chrome.cast.DialAppState.RUNNING ? (a = b.N.extraData || {}, c = a.screenId || null, p8(b) && a.loungeToken ? a.loungeTokenRefreshIntervalMs ? a = HSa(b, {
            name: b.i.friendlyName,
            screenId: a.screenId,
            loungeToken: a.loungeToken,
            dialId: b.N.receiver.label,
            screenIdType: "shortLived"
        }, a.loungeTokenRefreshIntervalMs) : (g.qs(Error("No loungeTokenRefreshIntervalMs presents in additionalData: " + JSON.stringify(a) + ".")), a = ISa(b, c)) : a = ISa(b, c)) : a = r8(b);
        return a
    };
    g.k.HL = function(a) {
        var b = this;
    ...
    g.k.bH = function() {
        this.isDisposed() || (this.B = NSa(this), u8("Updating custom receivers: " + g.Nh(this.B)), chrome.cast.setCustomReceivers(this.B, g.Ha, (0, g.E)(function() {
    ...
    g.k.bw = function(a) {
        ...
        if (this.i = a) this.i.addUpdateListener(this.K), $Sa(this), this.Z("remotePlayerChange")
    };
    g.k.hT = function(a) {
        a ? ($Sa(this), this.Z("remotePlayerChange")) : this.bw(null)
    };
    g.k.BF = function() {
    ...
    g.k.connect = function(a, b) {
        ...
        } else Y8("Connecting without params"), this.i.connect({}, a, iRa());
        cTa(this)
    };
    g.k.iA = function(a) {
        this.i.iA(a)
    ...
    g.k.hw = function() {
        if (y9(this)) {
            ...
            var b = this.C;
            (a || b ? a && b && a.trackName == b.trackName && a.languageCode == b.languageCode && a.languageName == b.languageName && a.kind == b.kind : 1) || (this.C = a, yTa(this, a));
            a = Q8(this.Sb); - 1 === a.volume || Math.round(this.I.getVolume()) === a.volume && this.I.isMuted() === a.muted || this.V.isActive() || this.tN()
        } else xTa(this)
    };
    g.k.CL = function() {
    ...
    E9.prototype.cj = function(a) {
        return "cast-selector-receiver" === a ? "Cast..." : this.oo[a].name
    };
    ...
    g.k.load = function() {
        ...
        var a = (a = vTa()) ? a.currentTime : 0;
        var b = u9() ? new P8(o9(), void 0) : null;
        0 == a && b && (a = L8(Q8(b)));
        0 !== a && this.Qb(a);
        ATa(this, this.rd, this.rd);
        this.player.Tk(6)
    };
    g.k.unload = function() {
