(function(g) {
    ...
    var PPa = function(a, b) {
        ...
        y5 = function(a) {
            ...
            for (var c = {
                ...
                g.Ql(e, "transitionDelay", c.Mq / 20 + "s");
        ...
        QPa = function(a) {
            for (var b = 0; b < a.suggestionData.length; b++) {
                ...
                h = c.isLivePlayback ? "Live" : c.lengthSeconds ? g.XL(c.lengthSeconds) : "";
                d.update({
                    views_or_author: e,
                    duration: h,
                    link: f,
        ...
        F5 = function(a, b) {
            ...
            this.expandButton.Sa("click", this.oT,
                this);
        ...
        TPa = function(a) {
            for (var b = 0; b < a.suggestionData.length; b++) {
                ...
                var f = c.isLivePlayback ? "Live" : c.lengthSeconds ? g.XL(c.lengthSeconds) : "";
                var h = c.Ck();
                ...
                d.update({
                    ...
                    blink_rendering_hack: g.gj || g.fF ? "will-change: opacity" : void 0
                });
                d = d.Ga("ytp-suggestion-image");
                c = c.Ge();
        ...
        H5 = function(a) {
            ...
            g.V.call(this, {
                ...
                W: {
                    target: b.K,
                    href: "{{url}}",
                    "aria-label": g.BI("Watch on $WEBSITE", {
                        WEBSITE: g.CF(b)
                    }),
    ...
    g.k.rb = function() {
        ...
        a.D ? this.title.update({
            title: g.BI("More videos from $DNI_RELATED_CHANNEL", {
